...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("get_trap_count")
        .allowlist_function("get_trap_by_index")
        .allowlist_function("get_stair_count")
        .allowlist_function("get_stair_by_index")
        // Variables
        ...
        .allowlist_type("trap_data_t")
        .allowlist_type("stair_data_t")
